...
//	             System.out.println(op5);
		 ...
		 * //ofNullable()
		 * 
		 * Optional<String> op = Optional.ofNullable(s); System.out.println(op);
		 * 
		 * Optional<String> op1 = Optional.ofNullable(s1); System.out.println(op1);
		 */

		/*
		 * //isPresent()
		 * 
		 * Optional<String> op1 = Optional.ofNullable(s);
		...
		Optional<String> op = Optional.ofNullable(s); // hello
		Optional<String> op1 = Optional.ofNullable(s1);// null

		/*
		 * //orElse() //If value is present in container, then the value is return or
		 * default value will be provided
		 * 
		 * System.out.println(op.orElse("there is null"));
		 * System.out.println(op1.orElse("there is null"));
		 * 
		 * //orElseGet() //If value is present in container, then the value is return or
		 * takes value from the supplier System.out.println(op.orElseGet(() -> new
		 * String("there is null"))); System.out.println(op1.orElseGet(() -> new
		 * String("there is null")));
		 * 
		 * //orElseThrow() //If value is present in container, then the value is return
		 * or Exception thrown from the supplier System.out.println(op.orElseThrow(() ->
		 * new RuntimeException("there is null")));
